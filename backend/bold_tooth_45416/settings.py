"""
Django settings for bold_tooth_45416 project.
...
ROOT_URLCONF = 'bold_tooth_45416.urls'
...
WSGI_APPLICATION = 'bold_tooth_45416.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "bold_tooth_45416 API",
    "DESCRIPTION": "API documentation for bold_tooth_45416 App",
    "VERSION": "v1",
}
